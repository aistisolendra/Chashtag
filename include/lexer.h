...
class Lexer
{
    enum token
    {
        ...
        token_decrement = -39,
        token_not = -40,
        token_string_literal = 42,
        token_double_quotes = 43,
        token_string_type = 44
    };
...
public:
    Lexer(string name) : sourceName(name)
    {
        ...
        KeywordRegistry["function"] = token_fn;
        ...
        KeywordRegistry["define"] = token_define;
    ...
    bool isTokenDefine() { return currentToken == token_define; }
